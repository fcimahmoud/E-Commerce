...
namespace Persistence.Repositories
{
        ...
        where TEntity : BaseEntity<TKey>
    {
        ...
        public async Task<IEnumerable<TEntity?>> GetAllAsync(bool trackChanges) => trackChanges ? await _storeContext.Set<TEntity>().ToListAsync() : await _storeContext.Set<TEntity>().AsNoTracking().ToListAsync();
